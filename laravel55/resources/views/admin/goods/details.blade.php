                                ...
                                <div class="container" >
                                    <div class="btn-group hidden-xs" id="stutar" role="group">
                                        <button id="add" type="button" class="btn btn-outline btn-default">
                                            <a class="glyphicon glyphicon-plus" aria-hidden="true"  data-toggle="modal" style="color: black">新增规格</a>
                                        </button>
                                        ...
                                        <tbody>
                                            @foreach ($goods as $v)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$v->id}}</td>
                                                    <td>{{$v->name}}</td>
                                                    <td><img src="{{$v->path}}s_{{$v->image}}" alt=""></td>
                                                    <td>{{$v->number}}</td>
                                                    <td>{{$v->price}}</td>
                                                    <td>{{$v->state}}</td>
                                                    <td>
    ...
    $('.filter-box').selectFilter({
        callBack : function (val){
            if(val==""){
                ...
                location.href = "/admin/goodsinfo/"+ val;
            }
            ...
            (function() {
                ...
                $("#edit").click(function(){
                    ...
                    if( n == 1 ){
                        ...
                        // alert(b);
                        var txt = "修改"+$("#goods .selected").eq(0).children().eq(2).text()+"规格";
                        var option = {
                            title: "提醒框",
                            btn: parseInt("0011",2),
                            onOk: function(){
                                location.href="/admin/goodsinfo/"+b+"/edit";
                            }
                        }
                        window.wxc.xcConfirm(txt, "custom", option);
                ...
                $("#goods .edit").click(function(){
                    ...
                    var txt = "修改"+$(this).parent().siblings().eq(2).text()+"规格";
                    var option = {
                        title: "提醒框",
                        btn: parseInt("0011",2),
                        onOk: function(){
