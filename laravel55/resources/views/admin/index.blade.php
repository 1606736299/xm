        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="mailbox.html"><i class="fa fa-camera"></i> <span class="nav-label">商品分类 </span><span class="label label-warning pull-right">16</span></a>
                        <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-edit"></i> <span class="nav-label">商品信息</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <!-- 修改的 -->
                            <li><a class="J_menuItem" href="/admin/goods">产品详情</a>
                            </li>
                             <li><a class="J_menuItem" href="/admin/goodsinfo">添加规格</a>
                            </li>
                            <li><a class="J_menuItem" href="/admin/goodsinfo/create">查看规格</a>
                            </li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-line-chart"></i> <span class="nav-label">订单管理</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                    ...
                    <li>
                      ...
                      <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="/admin/adminuser">管理员列表</a>
                            </li>
                        </ul>
                    </li>
                </ul>
